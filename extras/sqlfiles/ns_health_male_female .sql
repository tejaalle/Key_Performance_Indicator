CREATE TABLE ns_health_male_female(
   Topic           VARCHAR(78) 
  ,Characteristics VARCHAR(89) PRIMARY KEY
  ,Total           NUMERIC(5,2)
  ,Male            NUMERIC(5,1)
  ,Female          NUMERIC(5,1)
);
INSERT INTO ns_health_male_female(Topic,Characteristics,Total,Male,Female) VALUES
...
,('Health Conditions','Injuries within the past 12 months causing limitation of normal activities (%)',NULL,NULL,NULL)
,('Health Conditions','Injuries in the past 12 months; sought medical attention (%)',NULL,NULL,NULL)
...
,('Health Conditions','Breast cancer incidence (per 100000 population)',NULL,NULL,101.9)
,('Health Conditions','Prostate cancer incidence (per 100000 population)',NULL,148.3,NULL)
...
,('Health Behaviours','Bike helmet use (%)',NULL,NULL,NULL)
,('Human Function','Participation and activity limitation; sometimes or often (%)',NULL,NULL,NULL)
,('Human Function','Functional health; good to full (%)',NULL,NULL,NULL)
,('Accessibility','Influenza immunization (%)',46.2,42,50)
,('Accessibility','Mammography (%)',NULL,NULL,69)
,('Accessibility','Pap smear (%)',NULL,NULL,81)
,('Accessibility','Regular medical doctor (%)',92.3,89.9,94.5)
,('Accessibility','Wait time for hip fracture surgery (Proportion with surgery within 48 hours) (proportion)',79.6,NULL,NULL)
,('Appropriateness','Caesarean section (proportion)',26.5,NULL,26.5)
,('Appropriateness','Patients with repeat hospitalizations for mental illness (%)',9.6,NULL,NULL)
,('Effectiveness','Ambulatory care sensitive conditions (per 100000 population)',316,355,279)
,('Effectiveness','30-day acute myocardial infarction (AMI) in-hospital mortality (rate)',6.9,NULL,NULL)
,('Effectiveness','30-day stroke in-hospital mortality (rate)',17.9,NULL,NULL)
,('Effectiveness','Self-injury hospitalizations (per 100000 population)',72,59,85)
,('Effectiveness','30-day obstetric readmission rate (%)',2.3,NULL,2.3)
,('Effectiveness','30-day readmission - patients age 19 and younger (%)',6.1,NULL,NULL)
,('Effectiveness','30-day surgical readmission rate (%)',6.3,NULL,NULL)
,('Effectiveness','30-day medical readmission rate (%)',12.2,NULL,NULL)
...
,('Continuity','30-day readmission rate for mental illness (%)',12.6,NULL,NULL)
...
,('Deaths','Breast cancer; deaths (per 100000 population)',11.9,NULL,21.5)
,('Deaths','Prostate cancer; deaths (per 100000 population)',9.2,23.7,NULL)
...
,('Deaths','Human immunodeficiency virus [HIV] disease; deaths (per 100000 population)',0.6,NULL,NULL)
...
,('Living and Working Conditions','Unemployment (%)',8.8,NULL,NULL)
,('Living and Working Conditions','Youth unemployment; aged 15 to 24 (%)',16.7,NULL,NULL)
...
,('Community','Population density (persons per km<sup>2</sup>)',17.41,NULL,NULL)
,('Community','Dependency ratio (%)',58.6,NULL,NULL)
,('Community','Youth; under 20 years; as a proportion of total population (%)',21.9,NULL,NULL)
,('Community','Seniors; 65 years and over; as a proportion of total population (%)',15,NULL,NULL)
...
,('Health System','Contact with a medical doctor in the past 12 months (%)',NULL,NULL,NULL)
...
,('Health System','Hysterectomy (per 100000 population)',411,NULL,411)
,('Health System','Inflow/outflow ratio - Overall (ratio)',NULL,NULL,NULL)
...
,('Resources','Doctors rate - General/family physicians (per 100000 population)',122,NULL,NULL)
,('Resources','Doctors rate - Specialist physicians (per 100000 population)',119,NULL,NULL);
